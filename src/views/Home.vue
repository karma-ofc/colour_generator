...
.generate-btn {
  ...
  box-shadow: 0 6px 12px -2px rgba(102, 126, 234, 0.3), 0 4px 8px -1px rgba(102, 126, 234, 0.2);
}

.generate-btn:hover:not(:disabled) {
  transform: translateY(-3px) scale(1.03);
  box-shadow: 0 12px 30px -6px rgba(102, 126, 234, 0.5), 0 6px 12px -2px rgba(102, 126, 234, 0.3);
}
...
.color-card {
  ...
  overflow: hidden;
  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
  box-shadow: 0 6px 12px -2px rgba(0, 0, 0, 0.4), 0 4px 8px -1px rgba(0, 0, 0, 0.3);
...
.color-card:hover {
  ...
  box-shadow: 0 12px 30px -6px rgba(0, 0, 0, 0.5), 0 6px 12px -2px rgba(0, 0, 0, 0.4);
}
